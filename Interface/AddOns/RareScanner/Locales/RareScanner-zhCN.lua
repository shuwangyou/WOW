...
if AL then
	...
	AL["MAP_TOOLTIP_ALREADY_COMPLETED"] = "该事件已完成。下次开始：%s"
	...
	AL["NAVIGATION_ENABLE_DESC"] = "启用时导航箭头会显示在主按钮旁边，可以访问发现的更新或者更老的实体"
	...
	AL["NOTE_156709"] = "你需要击杀无面破坏者（普通NPC）让他刷新"
	AL["NOTE_157162"] = "在神庙内，入口坐标22,24"
	AL["NOTE_158531"] = "你需要击杀虚空圣物Neferset（普通NPC）让他刷新"
	AL["NOTE_158632"] = "你需要击杀Burbling Fleshbeast（普通NPC）让他刷新"
	AL["NOTE_158706"] = "你需要击杀Oozing Putrefaction（普通NPC）让他刷新"
	AL["NOTE_159087"] = "你需要击杀N'Zoth Bonestripper（普通NPC）让他刷新"
