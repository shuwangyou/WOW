...
GridStatusRaidDebuff:DebuffId(zoneid, 317149, 10000, 5, 5, true) --Gastric Fluids
GridStatusRaidDebuff:DebuffId(zoneid, 311122, 10000, 5, 5, true) --Jagged Wound
GridStatusRaidDebuff:DebuffId(zoneid, 313977, 10000, 5, 5, true) --Curse of the Void
GridStatusRaidDebuff:DebuffId(zoneid, 314905, 10000, 5, 5, true, true) --Shadow Wounds
GridStatusRaidDebuff:DebuffId(zoneid, 311508, 10000, 5, 5, true) --Clot Blood
GridStatusRaidDebuff:DebuffId(zoneid, 307044, 10000, 5, 5, true) --Nightmare Antibody
GridStatusRaidDebuff:DebuffId(zoneid, 313951, 10000, 5, 5, true, true) --Reaping Wound
GridStatusRaidDebuff:DebuffId(zoneid, 318788, 10000, 5, 5, true) --Corrupted Touch
GridStatusRaidDebuff:DebuffId(zoneid, 310830, 10000, 4, 4, true) --Disorienting Strike
GridStatusRaidDebuff:DebuffId(zoneid, 314850, 10000, 5, 5, true) --Expanding Darkness
GridStatusRaidDebuff:DebuffId(zoneid, 318409, 10000, 6, 6, true) --Discordant Whispers
GridStatusRaidDebuff:DebuffId(zoneid, 311116, 10000, 6, 6, true) --Reverberating Slam
GridStatusRaidDebuff:DebuffId(zoneid, 314847, 10000, 6, 6, true, true) --Decapitate
GridStatusRaidDebuff:DebuffId(zoneid, 314430, 10000, 5, 5, true) --Lingering Blood
GridStatusRaidDebuff:DebuffId(zoneid, 316677, 10000, 5, 5, true) --Germinating Parasite
GridStatusRaidDebuff:DebuffId(zoneid, 316506, 10000, 5, 5, true) --Heartpiercer Venom
GridStatusRaidDebuff:DebuffId(zoneid, 311182, 10000, 5, 5, true) --Void Shear
GridStatusRaidDebuff:DebuffId(zoneid, 281721, 10000, 5, 5, true, true) --Vile Bile
GridStatusRaidDebuff:DebuffId(zoneid, 316951, 10000, 5, 5, true) --Voracious Charge
...
GridStatusRaidDebuff:DebuffId(zoneid, 307053, 10000, 5, 5, true) --Lava Pools
GridStatusRaidDebuff:DebuffId(zoneid, 314451, 10000, 5, 5, true) --Leeching Bite
GridStatusRaidDebuff:DebuffId(zoneid, 313460, 10000, 5, 5, true) --Nullification
GridStatusRaidDebuff:DebuffId(zoneid, 311362, 10000, 5, 5, true) --Rising Heat
GridStatusRaidDebuff:DebuffId(zoneid, 314593, 10000, 5, 5, true) --Mind-Numbing Toxin
...
GridStatusRaidDebuff:DebuffId(zoneid, 314993, 27, 8, 8, true) --吸取精华
