...
local IsSpellInRange, UnitInRange, UnitIsDead, UnitIsVisible, UnitIsUnit, UnitPhaseReason, UnitIsConnected
    = IsSpellInRange, UnitInRange, UnitIsDead, UnitIsVisible, UnitIsUnit, UnitPhaseReason, UnitIsConnected

local function GroupRangeCheck(self, unit)
	if UnitIsUnit(unit, "player") then
		return true
    elseif UnitPhaseReason(unit) and UnitIsConnected(unit) then
        return false --abyui
