...
-- 1表示本职业自身 2表示可以给其他职业 负数表示不显示在次要状态中
-- 逻辑是所有选项都有价值，选了（不管正负）就显示在主状态里，没选的，正数才显示在次要状态，所以负数其实无所谓
local interest_buffs = {
    ["DEATHKNIGHT"] = {
        [48707]     = 1, -- [反魔法护罩] 1min 5s
        [81256]     = 1, -- [符文刃舞] 3min 8s
        [195181]    = 1, -- [白骨之盾] 30s 层数
        [194679]    = 1, -- [符文分流] 25秒冲能 4秒 伤害降低30%
        [116888]    = 1, -- 炼狱蔽体 114556 炼狱效果 3min 3s
        [48792]     = 1, -- [冰封之韧] 3min DPS
        [55233]     = 1, -- [吸血鬼之血] 1.5min 破斧
        --[205725]    = 1, -- 反魔法盾天赋 - 最大生命提高 8.0似乎没了
        --[207319]    = 1, -- [血肉之盾] 1min 10s 8.0似乎没了
        --[206977]    = 1, -- [血之镜像] 2min 10s  8.0似乎没了
    },
    ["DRUID"] = {
    ...
    ["MONK"] = {
        [122278] = 1, -- [躯不坏] 天赋 2min 伤害降低20%-50%
        [122783] = 1, -- [散魔功] 天赋 2min 6s -60%魔法
        [125174] = 1, -- [业报之触] 10s 1.5min 122470 DPS吸收伤害
        [120954] = 1, -- [壮胆酒] 7min 15s 115203
        [243435] = 1, -- [壮胆酒] 织雾1.5m 小减伤
        [115176] = 1, -- [禅悟冥想] --受到的所有伤害降低60%，持续8秒。移动，受到近战攻击或进行其他动作会取消该效果。
        [116849] = 2, -- [作茧缚命] 3min 12s
        [124273] = 1, -- 重度醉拳 debuff
        [124274] = 1, -- 中度醉拳 debuff
        [215479] = 1, -- [铁骨酒] 115308 21cd 3charge 6s 使醉拳化解的伤害量额外提高40%，持续6秒。
        --[152173] = 1,  -- [屏气凝神] 1.5min 8s DPS大招
    },
    ["PALADIN"] = {
    ...
    ["ROGUE"] = {
        ...
        [5277]      = 1, -- 闪避 2min 10s
        [199754]    = 1, -- 还击 2min 招架提高100% 狂徒贼替代闪避
        [45182]     = 1, -- 死亡谎言 装死天赋31230的buff 6min 3s
    },
    ["SHAMAN"] = {
        [108271]    = 1, -- 星界转移1.5min
    ...
    ["WARRIOR"] = {
        ...
        [223658]    = -2, -- 安全守护 [捍卫] 拦截 20s 6s 198304
        [190456]    = -1, -- 无视苦痛 根据怒气
    ...
    ["DEMONHUNTER"] = {
        ...
        [162264]    = 1, -- 191427恶魔变形 浩劫 4min 30s
...
GridStatusTankCooldown.defaultDB = {
	...
	alert_tankcd = {
		...
		active_spellids = { -- default spells --会受到伤害的最前面，加治疗效果的次之，减伤再次，最次是加生命的
            ...
            122278, -- [躯不坏] 天赋 2min 伤害降低20%-50%
            120954, -- [壮胆酒] 7分钟大招
            115176, -- [禅悟冥想] 天赋-60%伤害，不能动
            124273, -- 重度醉拳
            187827, -- DH恶魔变形+30%生命
            55233,  -- 吸血鬼之血 破斧+%生命+治疗量
            48792,  -- DK冰封之韧
            81256,  -- 符文刃舞 40%招架
            48707,  -- 反魔法盾天赋+25%生命
            27827,  -- 牧师天使
            ...
            113862, -- 强化渐隐术
            45438,  -- 冰箱
            104773, -- 术士心志坚定 [不灭决心] 3min 8s
            212800, -- DH闪躲
            196555, -- DH无敌
            162264, -- DH变形吸血
            22812,  -- 小德树皮
            125174, -- [业报之触] 踏风 吸收转移伤害
...
function GridStatusTankCooldown:OnSpellListChanged()
    ...
    for id, flag in pairs(flags) do
        if flag > 0 and not active_spells_map[id] then
            if flags[id] == 2 then --or flags[id] == -2 then
