...
local CURRENCY_IDS_BY_NAME = {
    ...
    PEARL_8_2_0 = 1721,
    ILLUSION_8_3_0 = 1755,
    CORRUPT_METAL_8_3_0 = 1719,
    NYALOTHA_ECHO_8_3_0 = 1803,
}
...
local MISCELLANEOUS_CURRENCY_IDS = {
    ...
    CURRENCY_IDS_BY_NAME.PEARL_8_2_0,
    CURRENCY_IDS_BY_NAME.ILLUSION_8_3_0,
    CURRENCY_IDS_BY_NAME.CORRUPT_METAL_8_3_0,
    CURRENCY_IDS_BY_NAME.NYALOTHA_ECHO_8_3_0,
}
