...
MEETINGSTONE_UI_DB = {
	...
	["global"] = {
		["serverDatas"] = {
			...
			["ActivitiesData"] = {
				["data"] = "$1$Z$S261`魔兽主播活动`进攻尼奥罗萨`2月1日（周六）晚8点，快和斗鱼TV人气主播：痴汉万宝路（房间号：1340947）共同闯荡觉醒之城*J尼奥罗萨，觉醒之城，它就位于黑暗帝国虚空笼罩的中心。你需要在这里面对疯狂的预兆和难以名状的恐怖，最终才能与恩佐斯的本尊对峙。勇士们，赶快随着斗鱼TV主播一起，为了艾泽拉斯的存亡，与他展开宿命的对决。`http://w.163.com/special/convene-stone/`2`3$$",
			},
			["MallData"] = {
		...
		["ActivityProfiles"] = {
			...
			["英灵殿（史诗钥石）"] = {
				["ItemLevel"] = 880,
				["Summary"] = "斗士 来6--9  来BB   补个老司机MT DPS 打手",
				["PvPRating"] = 0,
				["MaxLevel"] = 110,
				["MinLevel"] = 110,
				["HonorLevel"] = 0,
